...
| `GET /security/flows` | `fetchDataFlows` | `src/pages/admin/sysops/SecurityArchPage.tsx` |
| `GET /security/boundary-policy` | `fetchBoundaryRules` | `src/pages/admin/sysops/SecurityArchPage.tsx` |
| `GET /security/external-access` | `fetchExternalAccess` | `src/pages/admin/sysops/SecurityArchPage.tsx` |
| `GET /augment/strategies` | `fetchStrategies` | `src/pages/admin/knowledge/AugmentPage.tsx` |
| `GET /augment/routes` | `fetchRoutes` | `src/pages/admin/knowledge/AugmentPage.tsx` |
| `GET /augment/cache` | `fetchCacheEntries` | `src/pages/admin/knowledge/AugmentPage.tsx` |
| `POST /augment/cache/{id}:reload` | `reloadCacheEntry` | `src/pages/admin/knowledge/AugmentPage.tsx` |
| `GET /catalog/assets` | `fetchDataAssets` | `src/pages/admin/datainfra/CatalogPage.tsx` |
| `GET /catalog/lineage` | `fetchLineages` | `src/pages/admin/datainfra/CatalogPage.tsx` |
| `GET /predops/models` | `fetchPredModels` | `src/pages/admin/mlops/PredOpsPage.tsx` |
