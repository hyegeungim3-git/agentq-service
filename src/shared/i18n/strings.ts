...
const KO = {
  ...
  'tab.guide': '사용 가이드',
  'tab.settings': '환경설정',
  'tab.handover': '교대 인수인계',
  'tab.workorders': '작업지시 추적',
  ...
  'tab.handover.desc': '직전 조가 넘긴 것과 이번 조가 넘길 것',
  'tab.workorders.desc': '발행한 지시가 닫혔는지',
  'nav.field': '현장',
...
const EN: Record<UiKey, string> = {
  ...
  'tab.handover.desc': 'What the last shift passed on, and what this one will',
  'tab.workorders.desc': 'Whether issued orders were closed',
  'nav.field': 'Field',
