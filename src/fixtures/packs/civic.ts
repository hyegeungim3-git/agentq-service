...
import { CIVIC_AREAS, CIVIC_INDEX_ENTRIES } from '../civic/knowledgebase'
import { CIVIC_AGENT_OPS } from '../civic/agentops'
import { CIVIC_TRANSLATION } from '../civic/translation'
import { CIVIC_ADDRESS } from '../civic/mapping'
...
export const CIVIC_PACK: DomainPackData = {
  ...
  simulate: {
    ...
    translate: makeTranslationSimulator(CIVIC_TRANSLATION),
  ...
  knowledgeAreas: CIVIC_AREAS,
  indexEntries: CIVIC_INDEX_ENTRIES,
  agentOps: CIVIC_AGENT_OPS,
  mapping: {
    modes: ['address-single', 'address-batch', 'address-ocr', 'code-lookup'],
    address: CIVIC_ADDRESS,
    tagResult: null,
    tagsTargetNote: null,
    ocrDocument: '옥외광고물_표시신고서_2026-0812.pdf',
    addressExamples: ['강변동 시장 사거리', '신흥동 역앞', '송파동 먹자골목'],
    codeExamples: ['4111010100', '4111010700', '9999999999'],
  },
}
