...
export const AGENTS: AgentDefinition[] = [
  ...
  { id: 'report', name: '표준 보고서 작성', desc: '실적 데이터를 표준 양식 보고서로 작성합니다.', status: 'planned' },
  { id: 'meeting', name: '회의록 작성', desc: '녹음을 발언자 구분 회의록으로 정리합니다.', status: 'planned' },
  { id: 'knowledge', name: '지식 검색', desc: '축적 도면·문서를 온톨로지로 검색합니다.', status: 'planned' },
  { id: 'internalreg', name: '내규·규정 조회', desc: '사내 규정을 조항 근거와 함께 조회합니다.', status: 'planned' },
  ...
  { id: 'review', name: '문서 사전 검토', desc: '기안문을 사규와 대조해 위반 소지를 검토합니다.', status: 'planned' },
